      ...
      <div className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8">
            Premium cables delivered nationwide with reliability and excellence as our standard.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="#products" 
              className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 px-8 py-4 rounded-md font-bold text-lg transition-colors flex items-center justify-center"
            >
              Explore Products
            ...
            <a 
              href="#contact" 
              className="bg-white hover:bg-gray-100 text-blue-600 dark:bg-gray-800 dark:text-blue-300 dark:hover:bg-gray-700 px-8 py-4 rounded-md font-bold text-lg transition-colors flex items-center justify-center"
            >
              Get a Quote
            </a>
          </div>
